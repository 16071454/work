...
QT_MOC_LITERAL(3, 34, 8), // "_strlist"
QT_MOC_LITERAL(4, 43, 16), // "slot_dosomething"
QT_MOC_LITERAL(5, 60, 4), // "path"
QT_MOC_LITERAL(6, 65, 14), // "replyFinished1"
QT_MOC_LITERAL(7, 80, 22) // "slot_clear_tablewidget"

    },
    "scanThread\0signal_vertify_finish\0\0"
    "_strlist\0slot_dosomething\0path\0"
    "replyFinished1\0slot_clear_tablewidget"
};
...
void scanThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_vertify_finish((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->slot_dosomething((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->replyFinished1(); break;
        case 3: _t->slot_clear_tablewidget(); break;
        default: ;
        }
        ...
        {
            typedef void (scanThread::*_t)(QString );
...
// SIGNAL 0
void scanThread::signal_vertify_finish(QString _t1)
{
