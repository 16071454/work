...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        Dialog->resize(818, 518);
        QIcon icon;
        icon.addFile(QStringLiteral(":/imag/logo.png"), QSize(), QIcon::Normal, QIcon::Off);
        Dialog->setWindowIcon(icon);
        Dialog->setStyleSheet(QStringLiteral("QDialog#Dialog{background-color: rgb(128, 128, 128);}"));
        ...
        horizontalLayout_head->setSpacing(6);
        horizontalLayout_head->setObjectName(QStringLiteral("horizontalLayout_head"));
        horizontalLayout_head->setSizeConstraint(QLayout::SetDefaultConstraint);
