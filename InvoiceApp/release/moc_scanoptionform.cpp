...
QT_MOC_LITERAL(4, 42, 16), // "signal_auto_scan"
QT_MOC_LITERAL(5, 59, 20), // "signal_check_invoice"
QT_MOC_LITERAL(6, 80, 23), // "siganl_set_invoice_type"
QT_MOC_LITERAL(7, 104, 11), // "INVOICETYPE"
QT_MOC_LITERAL(8, 116, 7), // "setText"
QT_MOC_LITERAL(9, 124, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(10, 146, 23), // "on_toolButton_3_clicked"
QT_MOC_LITERAL(11, 170, 23), // "on_toolButton_2_clicked"
QT_MOC_LITERAL(12, 194, 21) // "on_toolButton_clicked"

    },
    "scanoptionForm\0signal_continue_scan\0"
    "\0type\0signal_auto_scan\0signal_check_invoice\0"
    "siganl_set_invoice_type\0INVOICETYPE\0"
    "setText\0on_pushButton_clicked\0"
...
void scanoptionForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_continue_scan((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->signal_auto_scan((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->signal_check_invoice(); break;
        case 3: _t->siganl_set_invoice_type((*reinterpret_cast< INVOICETYPE(*)>(_a[1]))); break;
        case 4: _t->setText((*reinterpret_cast< INVOICETYPE(*)>(_a[1]))); break;
        ...
        {
            typedef void (scanoptionForm::*_t)(int );
        ...
        {
            typedef void (scanoptionForm::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&scanoptionForm::signal_auto_scan)) {
                *result = 1;
            }
        }
        {
        ...
        {
            typedef void (scanoptionForm::*_t)(INVOICETYPE );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&scanoptionForm::siganl_set_invoice_type)) {
                *result = 3;
            }
        }
    }
...
// SIGNAL 0
void scanoptionForm::signal_continue_scan(int _t1)
{
...
// SIGNAL 1
void scanoptionForm::signal_auto_scan(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 3
void scanoptionForm::siganl_set_invoice_type(INVOICETYPE _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
