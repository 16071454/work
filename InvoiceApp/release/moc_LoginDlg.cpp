...
void Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Dialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Dialog::signal_mainshow)) {
                *result = 1;
            }
        }
        {
            typedef void (Dialog::*_t)(QString , QString , QString , QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Dialog::start_thread)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 0
void Dialog::signal_start_thread()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void Dialog::signal_mainshow()
{
    QMetaObject::activate(this, &staticMetaObject, 1, Q_NULLPTR);
}

// SIGNAL 2
void Dialog::start_thread(QString _t1, QString _t2, QString _t3, QString _t4, QString _t5)
{
